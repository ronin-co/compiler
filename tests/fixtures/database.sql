...
CREATE TABLE "teams" ("id" text, "locations" text, "billing.currency" text,  PRIMARY KEY (id));
...
INSERT INTO "teams" ("id", "locations", "billing.currency") VALUES
('team_39h8fhe98hefah8', '{"europe":"berlin"}', 'EUR'),
('team_39h8fhe98hefah9', '{"europe":"london"}', 'GBP');