...
test('expand column names', async () => {
  ...
  expect(transaction.statements).toEqual([
    {
      statement: `SELECT \"members\".\"id\", \"members\".\"ronin.locked\", \"members\".\"ronin.createdAt\", \"members\".\"ronin.createdBy\", \"members\".\"ronin.updatedAt\", \"members\".\"ronin.updatedBy\", \"members\".\"account\", \"including_account\".\"id\", \"including_account\".\"ronin.locked\", \"including_account\".\"ronin.createdAt\", \"including_account\".\"ronin.createdBy\", \"including_account\".\"ronin.updatedAt\", \"including_account\".\"ronin.updatedBy\", \"including_account\".\"id\" as \"including_account.id\", \"including_account\".\"ronin.locked\" as \"including_account.ronin.locked\", \"including_account\".\"ronin.createdAt\" as \"including_account.ronin.createdAt\", \"including_account\".\"ronin.createdBy\" as \"including_account.ronin.createdBy\", \"including_account\".\"ronin.updatedAt\" as \"including_account.ronin.updatedAt\", \"including_account\".\"ronin.updatedBy\" as \"including_account.ronin.updatedBy\" FROM \"members\" LEFT JOIN \"accounts\" as including_account ON (\"including_account\".\"id\" = \"members\".\"account\") LIMIT 1`,
      params: [],
      returning: true,
    },
  ]);
