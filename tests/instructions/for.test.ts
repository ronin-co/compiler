...
test('get single record including child records (one-to-many, defined manually)', async () => {
  ...
  expect(transaction.statements).toEqual([
    {
      statement: `SELECT "sub_beaches"."id", "sub_beaches"."ronin.locked", "sub_beaches"."ronin.createdAt", "sub_beaches"."ronin.createdBy", "sub_beaches"."ronin.updatedAt", "sub_beaches"."ronin.updatedBy", "including_visitors[0]"."id" as "visitors[0].id", "including_visitors[0]"."ronin.locked" as "visitors[0].ronin.locked", "including_visitors[0]"."ronin.createdAt" as "visitors[0].ronin.createdAt", "including_visitors[0]"."ronin.createdBy" as "visitors[0].ronin.createdBy", "including_visitors[0]"."ronin.updatedAt" as "visitors[0].ronin.updatedAt", "including_visitors[0]"."ronin.updatedBy" as "visitors[0].ronin.updatedBy", "including_visitors[0]"."id" as "visitors[0].id", "including_visitors[0]"."ronin.locked" as "visitors[0].ronin.locked", "including_visitors[0]"."ronin.createdAt" as "visitors[0].ronin.createdAt", "including_visitors[0]"."ronin.createdBy" as "visitors[0].ronin.createdBy", "including_visitors[0]"."ronin.updatedAt" as "visitors[0].ronin.updatedAt", "including_visitors[0]"."ronin.updatedBy" as "visitors[0].ronin.updatedBy", "including_visitors[0]"."handle" as "visitors[0].handle", "including_visitors[0]"."firstName" as "visitors[0].firstName" FROM (SELECT * FROM "beaches" LIMIT 1) as sub_beaches LEFT JOIN "ronin_link_beach_visitors" as "including_visitors[0]" ON ("including_visitors[0]"."source" = "sub_beaches"."id") LEFT JOIN "accounts" as "including_visitors[0]" ON ("including_visitors[0]"."id" = "including_visitors[0]"."target")`,
      params: [],
      returning: true,
    },
  ]);
...
test('get single record including child records (one-to-many, defined manually, multiple fields)', async () => {
  ...
  expect(transaction.statements).toEqual([
    {
      statement: `SELECT "sub_beaches"."id", "sub_beaches"."ronin.locked", "sub_beaches"."ronin.createdAt", "sub_beaches"."ronin.createdBy", "sub_beaches"."ronin.updatedAt", "sub_beaches"."ronin.updatedBy", "including_volleyballTeams[0]"."id" as "volleyballTeams[0].id", "including_volleyballTeams[0]"."ronin.locked" as "volleyballTeams[0].ronin.locked", "including_volleyballTeams[0]"."ronin.createdAt" as "volleyballTeams[0].ronin.createdAt", "including_volleyballTeams[0]"."ronin.createdBy" as "volleyballTeams[0].ronin.createdBy", "including_volleyballTeams[0]"."ronin.updatedAt" as "volleyballTeams[0].ronin.updatedAt", "including_volleyballTeams[0]"."ronin.updatedBy" as "volleyballTeams[0].ronin.updatedBy", "including_volleyballTeams[0]"."id" as "volleyballTeams[0].id", "including_volleyballTeams[0]"."ronin.locked" as "volleyballTeams[0].ronin.locked", "including_volleyballTeams[0]"."ronin.createdAt" as "volleyballTeams[0].ronin.createdAt", "including_volleyballTeams[0]"."ronin.createdBy" as "volleyballTeams[0].ronin.createdBy", "including_volleyballTeams[0]"."ronin.updatedAt" as "volleyballTeams[0].ronin.updatedAt", "including_volleyballTeams[0]"."ronin.updatedBy" as "volleyballTeams[0].ronin.updatedBy", "including_volleyballTeams[0]"."locations" as "volleyballTeams[0].locations", "including_visitors[0]"."id" as "visitors[0].id", "including_visitors[0]"."ronin.locked" as "visitors[0].ronin.locked", "including_visitors[0]"."ronin.createdAt" as "visitors[0].ronin.createdAt", "including_visitors[0]"."ronin.createdBy" as "visitors[0].ronin.createdBy", "including_visitors[0]"."ronin.updatedAt" as "visitors[0].ronin.updatedAt", "including_visitors[0]"."ronin.updatedBy" as "visitors[0].ronin.updatedBy", "including_visitors[0]"."id" as "visitors[0].id", "including_visitors[0]"."ronin.locked" as "visitors[0].ronin.locked", "including_visitors[0]"."ronin.createdAt" as "visitors[0].ronin.createdAt", "including_visitors[0]"."ronin.createdBy" as "visitors[0].ronin.createdBy", "including_visitors[0]"."ronin.updatedAt" as "visitors[0].ronin.updatedAt", "including_visitors[0]"."ronin.updatedBy" as "visitors[0].ronin.updatedBy", "including_visitors[0]"."handle" as "visitors[0].handle", "including_visitors[0]"."firstName" as "visitors[0].firstName" FROM (SELECT * FROM "beaches" LIMIT 1) as sub_beaches LEFT JOIN "ronin_link_beach_volleyball_teams" as "including_volleyballTeams[0]" ON ("including_volleyballTeams[0]"."source" = "sub_beaches"."id") LEFT JOIN "teams" as "including_volleyballTeams[0]" ON ("including_volleyballTeams[0]"."id" = "including_volleyballTeams[0]"."target")LEFT JOIN "ronin_link_beach_visitors" as "including_visitors[0]" ON ("including_visitors[0]"."source" = "sub_beaches"."id") LEFT JOIN "accounts" as "including_visitors[0]" ON ("including_visitors[0]"."id" = "including_visitors[0]"."target")`,
      params: [],
      returning: true,
    },
  ]);
